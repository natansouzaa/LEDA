...
public class StudentLinkedListTest {
	...
	//@Test
	//	public void testQuestoes(){
	//		Assert.assertEquals(0, listaTeste.indexOf(3));
	//		listaTeste.removeWithIndex(0);
	//		Assert.assertArrayEquals(new Integer[] { 2, 1, 4, 2, 3 }, listaTeste.toArray());
	//		listaTeste.reverseS();
	//		Assert.assertArrayEquals(new Integer[] { 3, 2, 4, 1, 2 }, listaTeste.toArray());
	//	}
