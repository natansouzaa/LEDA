...
public class StudentBSTTest {
	...
	public void testSort() {
		Integer[] meuTeste = {2,4,6,0,1,-4,234};
		assertArrayEquals(new Integer[] {-4, 0, 1, 2 ,4 ,6 ,234}, ((SortComparatorBSTImpl) tree).sort(meuTeste));
	}
	...
	public void testReverseOrder() {
		fillTree(); // -40 -34 0 2 5 6 9 12 23 67 76 232
		assertArrayEquals(new Integer[] { 232, 76, 67, 23, 12, 9, 6, 5, 2, 0, -34, -40}, ((SortComparatorBSTImpl) tree).reverseOrder());
	}
